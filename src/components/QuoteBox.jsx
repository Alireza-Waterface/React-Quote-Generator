			...
			{ isLoading ? (
					...
					<div className="quote-box">
						...
						<div className="share">
							...
							<button className="share-btn clipboard" onClick={copyToClipboard} title='Copy to Clipboard'>
							...
							<button className="share-btn telegram" onClick={shareOnTelegram} title='Share on Telegram'>
